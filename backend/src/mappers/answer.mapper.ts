...
export function answerCreateDtoToAnswerEntity(dto: AnswerCreateDto): Partial<AnswerEntity>{
    const entity = new AnswerEntity();
    entity.answer = dto.answer;
    return entity;
}

export function answerUpdateDtoToAnswerEntity(dto: AnswerCreateDto): Partial<AnswerEntity>{
    const entity = new AnswerEntity();
    entity.answer = dto.answer;
    return entity;
}
